...
export class Timeline {
  constructor(sel) {
    ...
    this.TIMELINE = [
      ...
      detail: 'Completed an <strong>Associate Degree</strong> focused on cross-platform software development, software architecture and testing practices.<br><br>During my <strong>11-month</strong> internship at <strong>Inetum</strong> (hybrid), I contributed to enterprise applications using ASP.NET Core, Spring Boot and PL/SQL. Gained practical experience in microservices, Agile workflows and collaborative development with cross-functional teams.',
  ...
  detail: 'Prepared and passed the Spanish university entrance exam (<strong>selectividad</strong>) independently, \
        ...
        at the <strong>Polytechnic University of Catalonia (UPC · Barcelona School of Informatics, FIB)</strong>.<br><br>First year foundations covered \
        reasoning, modeling, and systems automation, as well as programming and computer fundamentals.',
          badges: [
            'Python',
            'C++',
            'Algorithms',
  ...
  detail: 'Awarded a <strong>CSC + HUST MSE Scholarship</strong> to complete a summer program at \
  ...
  _onClick(e) {
    ...
    // 1) Fijar max-height al alto actual antes del cambio (para animar)
    const startH = card.scrollHeight;
    card.style.maxHeight = startH + 'px';

    // 2) Cambiar estado + accesibilidad del botón
    ...
    // 3) Siguiente frame: medir destino y animar
    ...
    // 4) Limpiar inline al acabar para no dejar estilos pegados
    const onEnd = (ev) => {
